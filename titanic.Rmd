...
Another way is to run a randomforest with a search over 10 values of `mtry` using 10-fold cross validation. As we can see mtry=4 is the optimal value which results in the lowest RMSE; much better than the rpart model.
