...
```{r}
sigmoidCal <- glm(relevel(Class,ref='Dead')~boost,simulatedTrain,family = 'binomial')
coef(summary(sigmoidCal))
simulatedTrain$boostSig = predict(sigmoidCal,type = 'response')
sigmoidCal <- glm(relevel(Class,ref='Dead')~xgbsmote,simulatedTrain,family = 'binomial')
coef(summary(sigmoidCal))
simulatedTrain$xgbsmoteSig = predict(sigmoidCal,type = 'response')
